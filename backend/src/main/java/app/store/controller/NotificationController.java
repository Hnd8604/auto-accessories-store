...
public class NotificationController {
        ...
        @Operation(summary = "Subscribe to real-time notifications", description = "Opens an SSE (Server-Sent Events) connection to receive real-time notifications. "
                        +
        ...
        @GetMapping
        @Operation(summary = "Get my notifications", description = "Retrieves all notifications for the authenticated user with pagination, ordered by most recent first.")
